const TYPE_LIBRARY = {
  "ISTJ": {
    ...
    scene: "闭馆前的自习时段",
    traits: "秩序、坚毅、高度专注",
    galleryCopy: "你更像在灯光稳定的自习室里慢慢把任务啃完的人，安静、耐久，也很少被外界节奏带偏"
  },
  "ISFJ": {
    title: "随园的红墙",
    landmark: "随园 100 号楼",
    scene: "为同伴留心的日常",
    traits: "温婉、可靠、情感守护",
    galleryCopy: "你常常在不声不响里把事情照顾周全，让身边的人觉得安心，也让关系慢慢沉淀出温度"
  },
  "INFJ": {
    title: "德风园的思索",
    landmark: "德风园孔子像",
  ...
  "ISTP": {
    ...
    scene: "临场处理问题的行动时刻",
    traits: "务实、冷静、精准行动",
    galleryCopy: "你往往不靠夸张表达取胜，而是在需要出手的时候迅速判断、直接处理，把复杂情况拆成可执行的动作"
  },
  "ISFP": {
    title: "月亮湾的晚风",
    landmark: "月亮湾湖畔",
    scene: "顺着感觉慢慢靠近生活",
    traits: "浪漫、随性、感官审美",
    galleryCopy: "你对氛围、细节和当下感受特别敏锐，喜欢在舒服的节奏里做选择，也更容易把生活过出自己的审美"
  },
  "INFP": {
    title: "校园的小猫咪",
    landmark: "校园小角落",
  ...
  "INTP": {
    ...
    scene: "把问题拆开重组的深度思考",
    traits: "钻研、纯粹、逻辑建构",
    galleryCopy: "你对概念、原理和推演很有耐心，越是复杂的问题越容易激起你的兴趣，思路常常在安静里越走越深"
  },
  "ESTP": {
    title: "学则路的烟火气",
    landmark: "学则路夜市",
