...
- 题量：24 题
- 结构：4 组偏好 / 16 类结果
- 形式：以静态页面为主，无账号、无数据库，含一个用于天气查询的轻量 Vercel 接口
- 入口页面：[index.html](index.html)

## 本地预览

可以直接打开 [index.html](index.html)，它现在就是网站正式首页。
...
部署后，站点根路径会直接加载根目录的 [index.html](index.html)

## 仓库结构

- [app](app)：线上实际运行的页面、样式和前端脚本
- [api](api)：Vercel 线上函数，当前用于随园页天气查询
